...
- [ ] Step 1: `verify/` ディレクトリを作成

Run: `mkdir -p tmp/verify`
Expected: エラーなし

- [ ] Step 2: `verify/verify_hook.sh` を作成
...
- [ ] Step 3: `verify/verify_ghostty.applescript` を作成
...
- [ ] Step 4: 結果を `verify/results.md` にまとめる
...
- [ ] Step 4: 結果を `verify/results.md` の検証Bセクションに追記
...
- [ ] Step 1: `verify/verify_focus.applescript` を作成
...
- [ ] Step 5: 結果を `verify/results.md` の検証Cセクションに追記
